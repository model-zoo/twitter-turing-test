...
const shareTweet = tweet => {
  const tweetTemplate = `Can you guess whether this tweet is written by a human or generated by a neural network?\n\n "${tweet.body}"`;
      ...
      <div className="wrapper">
        ...
        <Typography variant="body2" className="styleLinks">
          <i>
            ...
            views expressed by the human tweets are not reflective of the
            author. The views expressed by the model tweets are a parody and do
            not necessarily reflect the opinion of any one individual.
          </i>
        </Typography>
      </div>
    </>
